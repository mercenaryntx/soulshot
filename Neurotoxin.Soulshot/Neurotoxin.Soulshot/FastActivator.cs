...
namespace Neurotoxin.Soulshot
{
    ...
    {
        // THIS VERSION NOT THREAD SAFE YET
        private static readonly Dictionary<Type, Func<T1, object>> ConstructorCache = new Dictionary<Type, Func<T1, object>>();
        public static object CreateInstance(Type objType, T1 arg1)
        {
            return GetConstructor(objType, new Type[] { typeof(T1) })(arg1);
        }

        private static Func<T1, object> GetConstructor(Type objType, Type[] argTypes)
        {
    ...
    {
        // THIS VERSION NOT THREAD SAFE YET
        private static readonly Dictionary<Type, Func<T1, T2, object>> ConstructorCache = new Dictionary<Type, Func<T1, T2, object>>();
        ...
        private static Func<T1, T2, object> GetConstructor(Type objType, Type[] argTypes)
        {
    ...
    {
        // THIS VERSION NOT THREAD SAFE YET
        private static readonly Dictionary<Type, Func<T1, T2, T3, object>> ConstructorCache = new Dictionary<Type, Func<T1, T2, T3, object>>();
        ...
        private static Func<T1, T2, T3, object> GetConstructor(Type objType, Type[] argTypes)
        {
